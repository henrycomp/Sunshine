package com.example.wxc.sunshine;
...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecast.add("Today - Hellfire");
        forecast.add("Tomorrow - Plague");
        forecast.add("Thursday - Noah's Ark");
        forecast.add("Friday - Rebirth of Earth");
        forecast.add("Saturday - Dinosaurs");
        forecast.add("Sunday - Rest");
